...
| sub_mode | integer | N | 子模式過濾 掃地 0    預設  1    僅吸塵(地毯吸塵)  3    靜音塵推 2000 地毯純吸 2001 地毯掃吸 2002 降噪掃吸 2003 降噪吸塵 洗地 0         預設  1         吸力模式 11        重污  12        標準 13        輕污(節能)  14        木地板(少水漬) 15        浸泡  16        單吸水(吸水) 17        強刷 18        地面配件(配件) 19        立面配件(配件節能) 20        單吸配件 1000      強效模式 1001      大水量模式 1002      快速洗地模式 1003      縫隙彈水模式 1004      長續航模式 |
...
| timezone_offset | integer | N | 時區偏移小時, 範圍 -12 ~ 14，表示 (UTC-12 ~ UTC+14）；預設UTC+0 |
| time_unit | string | N | 時間單位：day | hour，表示 按天 | 按小時 預設值：day(時間跨度>24 小時) ，hour(時間跨度<24 小時) |
| group_by | string | N | 時區偏移小時, 範圍 -12 ~ 14，表示 (UTC-12 ~ UTC+14）；預設UTC+0 |
