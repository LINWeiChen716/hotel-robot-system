...
```http
GET /data-board/v1/analysis/task/solicit/paging?timezone_offset=8&start_time=1693324800&end_time=1693497599&shop_id=331300000&time_unit=day&group_by=robot HTTP/1.1
```
### 回傳範例
