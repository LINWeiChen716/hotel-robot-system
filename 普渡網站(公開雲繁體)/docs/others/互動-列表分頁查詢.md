...
```http
GET /data-board/v1/analysis/task/interactive/paging?timezone_offset=8&start_time=1693324800&end_time=1693497599&shop_id=332200002&time_unit=day&group_by=robot HTTP/1.1
```
### 回傳範例
