...
```http
GET /data-board/v1/log/error/query_list?timezone_offset=8&start_time=1693324800&end_time=1693497599&shop_id=323400005&offset=0&limit=10&error_levels=Fatal,Error,Warning,Event&error_types=LostLocalization,LostRGBD HTTP/1.1
```
### 回傳範例
